...
const loginI18n: LoginI18n = {
  ...
  header: { title: 'Login', description: 'Login using user/user or admin/admin' },
};
  ...
  const loginError = useSignal(false);
    ...
    return (
      <LoginOverlay
          ...
          <p slot="footer" className="text-center"><a href="http://localhost:8080/register">Don't have an account?</a>
          </p>
      </LoginOverlay>
  );
}
